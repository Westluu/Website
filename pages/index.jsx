...
export default function Home() {
  ...
  A third-year computer engineering student, who is a highly motivated individual seeking to use programming and analytical skills to create meaningful impact. I am a quick learner and intrested in the field of software development and embedded system.
                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="Animation Profil" src={`https://cdn.discordapp.com/attachments/981024250091687946/1044045862294261811/PXL_20221111_194152714.png`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
