  ...
  return (
    <>
      <div className="py-20">
        ...
        <p className="text-xl text-white/50 font-normal text-center mb-5">The projects that I have done</p>

        <div className="grid grid-cols-1 sm:grid-cols2 md:grid-cols-2 xl:grid-cols-2 w-full gap-4 items-center mt-2">
          {_projects ? (
            projects ? (
              projects.map((_, __) => (
                <a href={_.link} target="_blank" rel="noreferrer" key={__} className="bg-neutral-800/10 p-4 hover:bg-neutral-800/20 shadow-lg hover:shadow-xl transition-all duration-200 rounded-lg w-full">
                  ...
                  <ul>
                    ...
                    <li className="text-md font-normal text-white/50 h-24">{_.point2}</li>
                    <li className="text-md font-normal text-white/50 h-24">{_.point3}</li>
                  </ul>
