...
export declare let Switch: (<TTag extends React.ElementType<any> = "button">(props: Props<TTag, SwitchRenderPropArg, "value" | "name" | "onChange" | "checked" | "defaultChecked" | SwitchPropsWeControl> & {
    ...
    Group: typeof Group;
    Label: (<TTag_1 extends React.ElementType<any> = "label">(props: Omit<import('@headlessui/react/dist/types.js').PropsOf<TTag_1>, ("as" | "children" | "refName" | "className") | "id"> & {
        as?: TTag_1 | undefined;
        ...
        className?: import('@headlessui/react/dist/types.js').PropsOf<TTag_1>["className"] | ((bag: {}) => string) | undefined;
    } : {}) & {
