...
export declare let Tab: (<TTag extends React.ElementType<any> = "button">(props: Props<TTag, TabRenderPropArg, TabPropsWeControl>, ref: Ref<HTMLElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null) & {
    ...
    }>>(props: Omit<import('@headlessui/react/dist/types.js').PropsOf<TTag_1>, "as" | "children" | "refName" | "className"> & {
        as?: TTag_1 | undefined;
        children?: React.ReactNode | ((bag: TabsRenderPropArg) => React.ReactElement<any, string | React.JSXElementConstructor<any>>);
        refName?: string | undefined;
    } & (true extends (import('@headlessui/react/dist/types.js').PropsOf<TTag_1> extends never ? never : "className" extends keyof import('@headlessui/react/dist/types.js').PropsOf<TTag_1> ? true : never) ? {
        className?: import('@headlessui/react/dist/types.js').PropsOf<TTag_1>["className"] | ((bag: TabsRenderPropArg) => string) | undefined;
    } : {}) & {
